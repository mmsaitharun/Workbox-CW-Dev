 ...
 */
@Entity
@SqlResultSetMappings({ @SqlResultSetMapping(name = "processModelResult", columns = { @ColumnResult(name = "PROCESS_DISPLAY_NAME"), @ColumnResult(name = "PROCESS_NAME"), @ColumnResult(name = "TASK_DEF") })
})
