...
public class WorkBoxDto {
	...
	/* this attriute is added for setting sla due date*/
	...
	public String toString() {
		return "WorkBoxDto [requestId=" + requestId + ", processName=" + processName + ", name=" + name + ", subject="
				...
				+ ", customAttributes=" + customAttributes + ", slaDueDate=" + slaDueDate + ", forwardedBy="
				+ forwardedBy + ", forwardedAt=" + forwardedAt + ", processDisplayName=" + processDisplayName + "]";
	}
