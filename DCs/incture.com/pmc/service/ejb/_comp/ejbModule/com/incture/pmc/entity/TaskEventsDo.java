...
@SqlResultSetMappings({ @SqlResultSetMapping(name = "TaskCountResult", columns = { @ColumnResult(name = "CREATED_DATE"), @ColumnResult(name = "TASK_COUNT") }),
		...
		@SqlResultSetMapping(name = "taskEventsInstanceList", columns = { @ColumnResult(name = "PROCESS_ID") }),
		
		@SqlResultSetMapping(name = "ownerEventsList", columns = { @ColumnResult(name = "MESSAGE"), @ColumnResult(name = "USER_DISPLAY_NAME"),@ColumnResult(name = "CREATED_AT"),@ColumnResult(name = "PROCESS_ID"), @ColumnResult(name = "EVENT_ID")}),
		@SqlResultSetMapping(name = "ownerNotification", columns = { @ColumnResult(name = "MESSAGE"),@ColumnResult(name = "CREATED_AT"),@ColumnResult(name = "PROCESS_ID"), @ColumnResult(name = "EVENT_ID"), @ColumnResult(name = "TASK_SUBJECT")})
