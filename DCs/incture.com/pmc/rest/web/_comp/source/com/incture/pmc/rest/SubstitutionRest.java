...
public class SubstitutionRest {
	...
	@EJB
	private SubstitutionRuleFacadeWsdlConsumerLocal substitutionServices;
    ...
    public List<UserDto> getSubstituteUsers(@PathParam("user")String  substitutedUser){
    	return substitutionServices.getSubstituteUsers(substitutedUser);
    }

	@GET
	@Path("/getSubstitutedUsers/{user}")
    public List<UserDto> getSubstitutedUsers(@PathParam("user")String  substitutingUserString){
