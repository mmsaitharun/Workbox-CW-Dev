...
public class ServicesUtil {
	...
	public static String buildNoRecordMessage(String queryName,
			Object... parameters) {
	...
	public static String appendLeadingChars(String input, char c, int finalSize)
		...
		if (paddingSize < 0) {
			throw new InvalidInputFault(
					getCSV("Value passed is greater than count:" + input
							+ " count is: " + finalSize));
		}
		while (paddingSize-- > 0) {
			strBuffer.append(c);
	...
	public static String appendTrailingChars(String input, char c, int finalSize)
			throws InvalidInputFault {
		StringBuffer strBuffer = new StringBuffer();
		if (input == null) {
			input = "";
	...
	public static void enforceMandatory(String field, Object value)
			throws InvalidInputFault {
