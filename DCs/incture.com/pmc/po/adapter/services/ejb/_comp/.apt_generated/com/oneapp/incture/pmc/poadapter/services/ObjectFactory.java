 ...
 * generated in the com.oneapp.incture.pmc.poadapter.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _BaseDto_QNAME = new QName("http://oneapp.com/incture/pmc/poadapter/services/", "baseDto");
    private final static QName _GetProcessDetails_QNAME = new QName("http://oneapp.com/incture/pmc/poadapter/services/", "getProcessDetails");
    private final static QName _GetProcessDetailsResponse_QNAME = new QName("http://oneapp.com/incture/pmc/poadapter/services/", "getProcessDetailsResponse");
    private final static QName _GetTaskDetails_QNAME = new QName("http://oneapp.com/incture/pmc/poadapter/services/", "getTaskDetails");
    private final static QName _GetTaskDetailsResponse_QNAME = new QName("http://oneapp.com/incture/pmc/poadapter/services/", "getTaskDetailsResponse");
    private final static QName _ProcessEventsDto_QNAME = new QName("http://oneapp.com/incture/pmc/poadapter/services/", "processEventsDto");
    private final static QName _TaskEventsDto_QNAME = new QName("http://oneapp.com/incture/pmc/poadapter/services/", "taskEventsDto");
    private final static QName _TaskOwnerDetailsDto_QNAME = new QName("http://oneapp.com/incture/pmc/poadapter/services/", "taskOwnerDetailsDto");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oneapp.incture.pmc.poadapter.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://oneapp.com/incture/pmc/poadapter/services/", name = "baseDto")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://oneapp.com/incture/pmc/poadapter/services/", name = "getProcessDetails")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://oneapp.com/incture/pmc/poadapter/services/", name = "getProcessDetailsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://oneapp.com/incture/pmc/poadapter/services/", name = "getTaskDetails")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://oneapp.com/incture/pmc/poadapter/services/", name = "getTaskDetailsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://oneapp.com/incture/pmc/poadapter/services/", name = "processEventsDto")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://oneapp.com/incture/pmc/poadapter/services/", name = "taskEventsDto")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://oneapp.com/incture/pmc/poadapter/services/", name = "taskOwnerDetailsDto")
